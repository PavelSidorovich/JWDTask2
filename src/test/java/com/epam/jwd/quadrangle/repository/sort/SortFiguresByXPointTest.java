...
public class SortFiguresByXPointTest {
    ...
    public void compare_shouldReturnPositiveNumber_ifIdOfTheFirstFigureIsLessThanSecondOne() {
        ...
        assertTrue(sorted.get(0).getPoints().get(0).getX() <= sorted.get(1).getPoints().get(0).getX());
        assertTrue(sorted.get(1).getPoints().get(0).getX() <= sorted.get(2).getPoints().get(0).getX());
        assertTrue(sorted.get(2).getPoints().get(0).getX() <= sorted.get(3).getPoints().get(0).getX());
    }
